...
// const SignUp = () => {
//   return (
//     <section id="signup" className="lg:px-16 lg:py-4 p-8 lg:mb-8">
//       <div className="grid md:grid-cols-2 gap-8 w-full ">
//         <div className="flex-col lg:py-18 flex items-start justify-between">
//           <h1 className="text-4xl font-semibold">Sign Up</h1>
//           <p className="text-lg my-4">Beniaih <span className="text-red-500">Ulinzi</span> Group</p>
//           <form
//             action=""
...
//               </label>
//             </div>
//             <div className="bg-red-500 rounded-md w-fit mx-auto"><Button title="Get started"/></div>
//           </form>
//         </div>
